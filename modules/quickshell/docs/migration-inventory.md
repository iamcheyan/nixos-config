...
- 剪贴板与 Voxtype 插件已迁入 `modules/anchor-shell/plugins/clipboard/` 和
  `modules/anchor-shell/plugins/voxtype/`，并从 Quickshell 的 `third-party/`
  删除旧源码副本；当前 Labwc 会话从 Anchor Shell 插件目录加载它们。
