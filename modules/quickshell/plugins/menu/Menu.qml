...
Item {
  ...
  property string defaultMenuPath: root.shell && root.shell.shellPath
    ? root.shell.shellPath + "/default/omarchy/omarchy-menu.jsonc"
    : integrationPath + "/default/omarchy/omarchy-menu.jsonc"
  property string userMenuPath: Quickshell.env("HOME") + "/.config/quickshell/extensions/omarchy-menu.jsonc"
